...
from lookahead.models.baichuan2_7b.modeling_baichuan_batch import BaichuanForCausalLM
from lookahead.models.baichuan2_7b.tokenization_baichuan import BaichuanTokenizer
...
for use_lookahead in [False, False, True, True]:
    ...
    messages.append({"role": "user", "content": "什么是DMP？"})
    ...
    token_count = sum([len(tokenizer.encode(x)) for x in response])
