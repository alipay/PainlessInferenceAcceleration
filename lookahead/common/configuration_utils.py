...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.debug_prefetch = kwargs.pop("debug_prefetch", False)
        self.prefetch_size = kwargs.pop("prefetch_size", 63)
        self.prefetch_length = kwargs.pop("prefetch_length", 12)
        self.prefetch_mode = kwargs.pop("prefetch_mode", 'trie')
