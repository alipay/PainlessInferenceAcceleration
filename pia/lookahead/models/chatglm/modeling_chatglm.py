...
from pia.lookahead.models.chatglm.configuration_chatglm import ChatGLMConfig
...
class ChatGLMPreTrainedModel(LookaheadPreTrainedModel):
    ...
    def get_masks(self, input_ids, past_key_values, padding_mask=None):
        ...
        # print(f'{padding_mask.shape=} {full_attention_mask.shape=} {past_length=} {seq_length=} {past_key_values is None}')
