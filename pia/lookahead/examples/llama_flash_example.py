...
from pia.lookahead.models.llama.modeling_llama_flash import LlamaForCausalLM
...
for use_lookahead in [False, False, True, True]:
    ...
    decoding_kwargs = {"use_lookahead": use_lookahead,
                       ...
                       "decoding_mode": 'one',   # degenerate to one branch lookahead, as flash-attention does not support customized attention mask.
