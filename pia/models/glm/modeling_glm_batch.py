...
from pia.common.pretrained_model_batch import LookaheadPreTrainedModel, LookaheadCache
from pia.models.glm.configuration_glm import GLMConfig
    ...
    def _validate_model_kwargs(self, model_kwargs: Dict[str, Any]):
        ...
        for key, value in model_kwargs.items():
            if value is not None and key not in model_args and key not in (
                    'use_lookahead', 'decoding_length', 'branch_length', 'debug_lookahead', 'decoding_kwargs',
