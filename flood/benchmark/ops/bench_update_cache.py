...
benchmark_func(update_fusion_cache, flood_k_out, key_states,
               indices, n_repeat=n_repeat)

benchmark_func(triton_update_fusion_cache, flood_k_out.view(-1,1024), key_states.view(-1,1024),
               indices, n_repeat=n_repeat)