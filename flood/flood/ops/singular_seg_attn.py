...
@triton.jit
def singular_single_seg_causal_attn_kernel(
        Q,
        K,
        V,
        Out,
...
@triton.jit
def singular_multi_seg_causal_attn_kernel(
        Q,
        K,
        V,
        Out,
...
def singular_seg_attn_fwd(q, k, v, meta, causal=False):
    ...
    if SINGLE:
        singular_single_seg_causal_attn_kernel[grid](
            q,
            k,
            v,
            o,
        ...
        singular_multi_seg_causal_attn_kernel[grid](
            q,
            k,
            v,
            o,
