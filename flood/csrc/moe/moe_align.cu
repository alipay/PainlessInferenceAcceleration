...
// TODO: this is temporarily adapted from
...
void moe_align_block_size(torch::Tensor topk_ids, int64_t num_experts,
  ...
  if (use_global_memory) {
    DISPATCH_PYTORCH_DTYPE_TO_FLOOD_INT_TYPE(
        topk_ids.scalar_type(), flood_type, [&] {
          ...
          auto kernel = moe_align_block_size_global_mem_kernel<flood_type>;
          kernel<<<1, num_thread, 0, stream>>>(
              topk_ids.data_ptr<flood_type>(),
    ...
    DISPATCH_PYTORCH_DTYPE_TO_FLOOD_INT_TYPE(
        topk_ids.scalar_type(), flood_type, [&] {
          ...
          auto kernel = moe_align_block_size_kernel<flood_type, uint16_t>;
          cudaFuncSetAttribute((void*)kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, shared_mem_i16);
    ...
    DISPATCH_PYTORCH_DTYPE_TO_FLOOD_INT_TYPE(
        topk_ids.scalar_type(), flood_type, [&] {
          auto kernel = moe_align_block_size_kernel<flood_type, int32_t>;
          cudaFuncSetAttribute((void*)kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, shared_mem_i32);
