...
model = LLM(model_name, quantization=None, tensor_parallel_size=1,
            enforce_eager=False, gpu_memory_utilization=0.90, max_model_len=10240,
...
#            '中国的首都是哪里？',
#            '杭州在哪里？']
prompts = ['Consider a sequence of real numbers \( a_1, a_2, a_3, \ldots, a_{2024} \) such that \( a_1 = 1 \) and for \( n \geq 1 \),\n\[ a_{n+1} = \\frac{a_n + 2}{a_n + 1} \]\nDetermine the value of \( a_{2024} \).']
...
for i, prompt in enumerate(prompts):
    ...
    sample_params = SamplingParams(max_tokens=2048, ignore_eos=False,
